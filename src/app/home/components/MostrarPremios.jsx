        ...
        {premios.map((premio, index) => (
          ...
          >
            ...
            <div className="relative h-48 overflow-hidden bg-gradient-to-br from-gray-100 to-gray-200">
              ...
              {/* Badge de stock */}
              {premio.stock !== null && (
                <div className={`absolute top-2 right-2 px-2 py-1 rounded-full text-xs font-bold ${premio.stock > 0
            ...
            <div className="p-5">
              ...
              <div className="flex items-center justify-between mt-auto">
                ...
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all ${premio.stock > 0
